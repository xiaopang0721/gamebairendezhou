        ...
        private showMainReusult(): void {
            if (this._resultArry.length) {
                if (this._resultArry[0] == 0) {
                    ...
                    this._viewUI.lan_win.img_result.skin = Path_game_bairendezhou.ui_bairendezhou_effect_zy + "tu_zy.png";
                    this._viewUI.lan_win.img_result1.skin = Path_game_bairendezhou.ui_bairendezhou_effect_zy + "tu_zy.png";
