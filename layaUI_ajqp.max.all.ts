...
module ui.ajqp.game_ui.bairendezhou.component {
    export class Effect_chongzhiUI extends View {
        ...
        public static  uiView:any ={"type":"View","props":{"width":173,"height":93},"child":[{"type":"Box","props":{"y":0,"x":0},"child":[{"type":"Button","props":{"y":40,"x":87,"stateNum":1,"skin":"tongyong_ui/game_ui/tongyong/general/btn_chongzhi.png","anchorY":0.5,"anchorX":0.5}},{"type":"Box","props":{"y":0,"x":0,"width":173,"height":93,"blendMode":"lighter"},"child":[{"type":"Button","props":{"y":-7,"x":0,"stateNum":1,"skin":"tongyong_ui/game_ui/tongyong/general/tu_chizhizz.png"}},{"type":"Image","props":{"x":79.16666666666666,"skin":"tongyong_ui/game_ui/tongyong/general/tu_czsg.png","renderType":"mask"},"compId":3}]}]}],"animations":[{"nodes":[{"target":3,"keyframes":{"x":[{"value":-173,"tweenMethod":"linearNone","tween":true,"target":3,"key":"x","index":0},{"value":183,"tweenMethod":"linearNone","tween":true,"target":3,"key":"x","index":40}]}}],"name":"ani1","id":1,"frameRate":24,"action":0}]};
        constructor(){ super()}
        createChildren():void {
