...
module gamebairendezhou.manager {
	export class BairendezhouHudMgr extends gamecomponent.managers.BaseMgr {
		static readonly EVENT_RETURN_MAPINFO: string = "BairendezhouHudMgr.RETURN_MAPINFO";
		static readonly PAGE_MAX: number = 100;
		private _data: any = [];
		constructor(game: Game) {
			super(game)
			this._delta = 3000;
			this._game.network.addHanlder(Protocols.SMSG_BAIRENDEZHOU_RETURN_MAPINFO, this, this.onOptHandler);
		}
